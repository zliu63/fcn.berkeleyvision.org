...
def fcn(mode):
    ...
    # layer10,
    net.score_pool3 = conv(net.pool3, 21, ks=1, pad=0)
    net.score_pool3_crop = crop(net.score_pool3, net.upscore2)
    net.integrate_pool3 = sumup(net.upscore2, net.score_pool3_crop)
    net.upscore3 = deconv(net.integrate_pool3, 21, ks=16, stride = 8)


    net.score = crop(net.upscore3, net.data)
